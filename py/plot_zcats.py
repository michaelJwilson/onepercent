...
mtl       = Table(fits.open('../run/quicksurvey/{}/{}/mtl-{}.fits'.format(program, epoch, program))[1].data)
zcat      = Table(fits.open('../run/quicksurvey/{}/{}/zcat-{}.fits'.format(program, epoch, program))[1].data)
